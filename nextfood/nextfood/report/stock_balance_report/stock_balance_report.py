	...
	def prepare_new_data(self):
		...
		for _key, report_data in self.item_warehouse_map.items():
			...
			if (
    			...
    			and report_data.bal_snf_kg == 0
       			and report_data.bal_fat_kg == 0
		...
		item_warehouse_map[group_by_key] = frappe._dict(
			{
    			...
    			"bal_snf_kg": opening_data.get("bal_snf_kg") or 0.0,
       			"bal_fat_kg": opening_data.get("bal_fat_kg") or 0.0,
		...
		columns.extend(
			[
				...
				},
				{
       			...
       			{
					"label": _("Balance Fat KG"),
					"fieldname": "bal_fat_kg",
					"fieldtype": "Float",
					"width": 160,
					"convertible": "qty",
				},
    			{
					"label": _("Balance SNF KG"),
					"fieldname": "bal_snf_kg",
					"fieldtype": "Float",
					"width": 160,
					"convertible": "qty",
				},
