# Copyright (c) 2025, rutika rathod and contributors
	...
	columns.extend(
		[
   ...
   
			{
   			...
   			{
				"label": _("Out Fat Kg"),
				"fieldname": "custom_fat_kg_change",
				"fieldtype": "Float",
				"width": 100,
				"convertible": "qty",
			},
      		{
				"label": _("Out SNF Kg"),
				"fieldname": "custom_snf_kg_change",
				"fieldtype": "Float",
				"width": 100,
				"convertible": "qty",
			},
			{
			...
			},
   			{
				...
				"fieldname": "fatkg_after_transaction",
				"fieldtype": "Float",
				"width": 100,
				"convertible": "qty",
			},
      		{
				...
				"fieldname": "snfkg_after_transaction",
				"fieldtype": "Float",
				"width": 100,
				"convertible": "qty",
			},
